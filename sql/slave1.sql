...
-- ----------------------------
INSERT INTO `pico_promote_image` VALUES (1, 'slave1', '<p style=\"margin: 0px; padding: 0px 0px 10px; color: #1d1d1d; font-size: 14px; line-height: 28px;\">在这样的特殊时期，居家娱乐变得非常火热。除了日常的大屏观影和主机游戏之外，越来越多的人开始把玩起了取得长足进步，可玩性不断提升的VR设备，Pico Neo 2就是其中的新旗舰。</p>\r\n<p style=\"margin: 0px; padding: 0px 0px 10px; color: #1d1d1d; font-size: 14px; line-height: 28px;\"><br />处理器升级、自由度更高、电磁手柄新技术等都成为2020年这款新品的主要卖点，今天，小编带大家开箱体验，看看这款全新的VR一体机有多大本事。</p>\r\n<figure class=\"image\"><img src=\"http://bbs-resource.oss-cn-zhangjiakou.aliyuncs.com/picture/1621562796321zyw.jpg\" alt=\"开箱\" width=\"1200\" height=\"900\" />\r\n<figcaption>Caption</figcaption>\r\n</figure>\r\n<p style=\"margin: 0px; padding: 0px 0px 10px; color: #1d1d1d; font-size: 14px; line-height: 28px;\">&nbsp;</p>', NULL, 1, NULL, NULL, '2019-11-29 16:31:20', NULL);
